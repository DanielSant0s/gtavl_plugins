...
void CCam_Process_AimWeapon(uint32_t this, CVector *a2, float a3, float a4, float a5);
void CCam_Process_FollowPed_SA(uint32_t this, CVector *a2, float a3, float a4, float a5, char a6);
