...
/* FIFO */
#define VIF0_FIFO       ((volatile __uint128_t *)(0x10004000))
#define VIF1_FIFO       ((volatile __uint128_t *)(0x10005000))
#define GIF_FIFO        ((volatile __uint128_t *)(0x10006000))
#define IPU_out_FIFO    ((volatile __uint128_t *)(0x10007000))
#define IPU_in_FIFO     ((volatile __uint128_t *)(0x10007010))
...
#define VU0_MEM         ((volatile __uint128_t *)(0x11004000))

/* VU1 */
#define VU1_MICRO       ((volatile u_long *)(0x11008000))
#define VU1_MEM         ((volatile __uint128_t *)(0x1100c000))
